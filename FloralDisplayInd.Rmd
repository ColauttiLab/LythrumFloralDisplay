...
Mom<-for( j in 1:length(PopCode)){
  ...
  df<-data.frame(Code,MeanVariance,MeanSkewness,MeanKurtosis,MeanFD,MeanSD,MeanEnd,MeanDuration,MeanVarianceSTD,MeanSkewnessSTD,MeanKurtosisSTD,MeanFDSTD)
} 
